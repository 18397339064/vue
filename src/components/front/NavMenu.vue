    ...
    <el-menu
      ...
      <el-submenu index="2">
        ...
        <el-submenu :index="'2-'+cate.ctid" v-for="cate in category">
          ...
          <el-menu-item :index="'2-'+cate.ctid+'-'+c.comid" v-for="c in cate.commodity" @click="shopxq(c.comid)">
            {{c.comname}}
          </el-menu-item>
        </el-submenu>
      ...
      <el-menu-item index="5" style="padding-left: 700px" @click="comname='userlogin'"><a
        v-if="useraccount==null">登录</a></el-menu-item>
      <el-menu-item index="6" style="padding-top:1px" v-if="useraccount!=null">欢迎{{useraccount}}</el-menu-item>
      <el-menu-item index="7" style="padding-left: 50px" @click="comname='zhuceuser'" v-if="useraccount==null"><a>注册</a>
      </el-menu-item>
      <el-menu-item index="8" style="padding-top:1px" v-if="useraccount!=null" @click="zhuxiao">注销</el-menu-item>
    </el-menu>
